            ...
            <div class="box-category">
              <ul id="cat_accordion">
                ...
                @foreach ($cats as $item)
                  <li><a href="category.html">{{$item->title_fa}}</a> <span class="down"></span>
                    @php
                         $pro=\App\Product::where('cat_id',$item->id)->latest()->paginate(10);
                    @endphp 
                        @foreach ($pro as $item2)
                            <ul>
                              <li><a href="category.html">{{$item2->name_fa}}</a> <span class="down"></span>
                            </ul>
                        @endforeach
                       </li>
                @endforeach
...
{{-- 
            ...
            <div class="side-item">
            @foreach ($products_best as $item)
            @php
                  $a=100-$item->discount;
                  $new_price=($item->price/100)*$a;
            @endphp
           
              <div class="product-thumb clearfix">
                <div class="image"><a href="product.html"><img src="{{$item->imageUrl}}" alt="{{$item->name_fa}} " title="{{$item->name_fa}} " class="img-responsive" /></a></div>
                <div class="caption">
                  <h4><a href="product.html">{{$item->name_en}}</a></h4>
                  <p class="price"> <span class="price-new">{{$new_price}} تومان</span> <span class="price-old">{{$item->price}}</span> <span class="saving">-{{$item->discount}}%</span> </p>
                </div>
              </div>
          ...
          <div id="content" class="col-sm-9">
            ...
            <div class="item"> <a href="{{$item->url}}"><img class="img-responsive" src="{{$item->imageUrl}}" alt="banner 1" style="width:900px;height:500px" /></a> </div>
            ...
            <div class="owl-carousel product_carousel">
              ...
              @endphp
                  ...
                  <div class="product-thumb clearfix">
                    <div class="image"><a href="product.html"><img src="{{$item->imageUrl}}" alt="تی شرت کتان مردانه" title="تی شرت کتان مردانه" class="img-responsive"  style="width:260px;height:170px"/></a></div>
                    <div class="caption">
                      <h4><a href="product.html">{{$item->name_fa}}</a></h4>
                      <p class="price"><span class="price-new">{{ $new_price}} تومان</span><span class="price-old">{{$item->price}}</span><span class="saving">-{{$item->discount}}%</span></p>
                    </div>
